				...
				?>
					<li id="admin-settings">
						<a href="<?php print_unescaped(\OC::$server->getURLGenerator()->linkToRoute('settings_admin')); ?>" tabindex="4"
							...
							<img class="app-icon svg" alt="" src="<?php print_unescaped(OC_Helper::imagePath('settings', 'admin.svg')); ?>">
							<div class="icon-loading-dark" style="display:none;"></div>
							<span>
								<?php p($l->t('Admin')); ?>
							</span>
					...
					<li id="admin-users">
						<a href="<?php print_unescaped(\OC::$server->getURLGenerator()->linkToRoute('settings_users')); ?>" tabindex="4"
							<?php if( $_['usermanagement_active'] ): ?> class="active"<?php endif; ?>>
							<img class="app-icon svg" alt="" src="<?php print_unescaped(OC_Helper::imagePath('settings', 'users.svg')); ?>">
							<div class="icon-loading-dark" style="display:none;"></div>
							<span>
								<?php p($l->t('Users')); ?>
							</span>
